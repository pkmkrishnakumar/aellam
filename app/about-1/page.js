...
export default function Page() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="HEALTH IS WEALTH">
                <div>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="heading2 no-margin-heading">
                                        <p>
                                        Team Aellam believes in creating a purposeful healthy life for all. To achieve this, one has to stay away from the lifestyle diseases arising due to our food & behavioral changes happening.

We derive inspiration & solution from one of the most powerful resources ever known, Yes Nature. Mother Nature which can give you cure and Only Health with No side effects.  We believe in transforming the society by delivering Value added solutions to everyone the natural way.Our technological solutions would assist you in your fight back against diseases that are common due to modern lifestyle & Food habits.
...
We leverage today’s modern technology and have unearthed ancient Natural herbs & food with medicinal values to deliver natural engineered solutions with zero side effects to you at the comfort of the home.

In circle of life, one has to come back to starting point to see happiness. Our team of Scientist, dieticians & pharma science experts have put together the proven, ancient methodology of science that is easy absorbable for skin & human body for a consistent healing track path for a healthy life. Come, Join us in leading a healthy purposeful Life.
                            ...
                            <div className="row">
                                    ...
                                    <div className="single-team">
                                        <div className="team-sides team-font-side">
                                            <div className="team-img">
                                                <img src="/assets/img/team/SrinivasanSamuel.jpg" alt="" />
                                            </div>
                                            <div className="team-content bg-18">
                                                <Link className="weight-700" href="#">Mr. Srinivasan Samuel</Link>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-team">
                                        <div className="team-sides team-font-side">
                                            <div className="team-img">
                                                <img src="/assets/img/team/DrSenthil.jpg" alt="" />
                                            </div>
                                            <div className="team-content bg-18">
                                                <Link className="weight-700" href="#">Dr.C. Senthil Kumar</Link>
                                                {/* <p>Group manager</p> */}
                                            </div>
                                        </div>
                                        <div className="team-sides team-back-side">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-team">
                                        <div className="team-sides team-font-side">
                                            <div className="team-img">
                                                <img src="/assets/img/team/DrSathya.jpg" alt="" />
                                            </div>
                                            <div className="team-content bg-18">
                                                <Link className="weight-700" href="#">Dr.P.Sathiamurthi</Link>
